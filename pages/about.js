  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="border-b-2 border-b-seafoam py-6">
        ...
        <p className="my-6">
          Development project information is sourced through a combination of crowdsourcing, public meeting agendas, local news outlets, independent research and scraping open data from sources including the Detroit Open Data Portal, the city’s Parcel Viewer and Detroit Documenters.
        </p>
      </div>
      ...
      <div className="border-b-2 border-b-seafoam py-6">
        ...
        <p className="my-6">
          <strong>Kate Abbey-Lambertz</strong>, editorial director of Detour Detroit, manages the tracker and built it with <strong>Jimmy McBroom</strong>, lead developer. (Disclosure: Jimmy is a data engineer with the City of Detroit, where his team manages the Open Data Portal. He works on the tracker in his personal capacity; the City of Detroit has no role in its operation or maintenance.)
        </p>
        <p className="my-6">
          Kate and Jimmy started collaborating on the project in 2020. Jimmy, a Detour reader and member, responded to an audience survey and suggested creating it, based on a prototype he built at the City in 2017 with research intern <strong>Ivy Tran</strong> and developer <strong>Jessica McInchak</strong>. In 2021, Kate and Detour were awarded a fellowship from the Reynolds Journalism Institute fellowship at the Missouri School of Journalism to build and launch the Detroit Development Tracker.
        </p>
        <p className="my-6">
        ...
        <p className="my-6">
          The Detroit Development Tracker project was funded by the Reynolds Journalism Institute, with support from RJI Executive Director <strong>Randy Picht</strong> and Director of Innovation <strong>Kat Duncan</strong>. It has received funding from the Detroit Equity Action Lab – Race and Justice Reporting Initiative, a program of The Damon J. Keith Center for Civil Rights, with support from DEAL Race and Justice Journalism Fellow <strong>Martina Guzmán</strong>. It has also received critical support from Detour Detroit members and individual donors.
        </p>
      </div>
