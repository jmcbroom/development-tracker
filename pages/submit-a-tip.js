...
export default function SubmitPage() {
  ...
  return (
    <section className="max-w-xl mx-auto pt-15 submit-form pb-44">
      <h2 className="pb-6">Let us know what you&apos;re seeing.</h2>
      <p className="pb-11">Do you see a project in your neighborhood or development activity? We&apos;ll check it out and get back to you.</p>
      <div>
